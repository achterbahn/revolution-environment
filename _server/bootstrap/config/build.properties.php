...
/* mysql */
$properties['mysql_string_dsn_test']= 'mysql:host=localhost;dbname=vagrant;charset=utf8';
...
$properties['mysql_string_username']= 'vagrant';
$properties['mysql_string_password']= 'vagrant';
...
/* sqlsrv */
$properties['sqlsrv_string_dsn_test']= 'sqlsrv:server=(local);database=vagrant';
$properties['sqlsrv_string_dsn_nodb']= 'sqlsrv:server=(local)';
$properties['sqlsrv_string_dsn_error']= 'sqlsrv:server=xyz;123';
$properties['sqlsrv_string_username']= 'vagrant';
$properties['sqlsrv_string_password']= 'vagrant';
